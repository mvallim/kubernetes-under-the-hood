...
```
192.168.254.254 gate-node01 gate-node01.kube.demo

192.168.1.10 kube-mast01 kube-mast01.kube.demo
192.168.1.11 kube-mast02 kube-mast02.kube.demo
192.168.1.10 kube-mast03 kube-mast03.kube.demo

192.168.2.10 kube-node01 kube-node01.kube.demo
192.168.2.11 kube-node02 kube-node02.kube.demo
192.168.2.10 kube-node03 kube-node03.kube.demo

192.168.3.10 glus-node01 glus-node01.kube.demo
192.168.3.11 glus-node02 glus-node02.kube.demo
192.168.3.10 glus-node03 glus-node03.kube.demo

192.168.4.10 hapx-node01 hapx-node01.kube.demo
192.168.4.11 hapx-node02 hapx-node02.kube.demo
```

### dnsmasq

If you are a using dnsmasq on your local machine execute this to use private DNS of this DEMO to domain 'kube.demo'

```
$ echo "server=/kube.demo/192.168.254.254" | sudo tee -a /etc/dnsmasq.d/server
